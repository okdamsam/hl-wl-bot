...
const commands = [wlSetupCommand, wlConfigCommand, wlPanelCommand, wlCancelCommand, wlRubricCommand, wlStatsCommand, wlHelpCommand, wlAdminPanelCommand, wlQueryCommand, wlUnclaimCommand, wlRefreshCommand, wlNotifyCommand, teamCommand].map((cmd) => cmd.toJSON());
